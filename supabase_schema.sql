...
BEGIN
  ...
  INSERT INTO public.staff_tracking (user_id, lat, lng, battery, speed_kmh, accuracy, current_task, status, last_update)
  VALUES (v_profile_id, p_lat, p_lng, COALESCE(p_battery, 100), COALESCE(p_speed_kmh, 0), COALESCE(p_accuracy, 0), p_current_task, COALESCE(p_status, 'active'), now())
