...
```
┌────────────┐     ┌──────────────┐     ┌──────────────────┐     ┌──────────────┐
│  Event     │────▶│  Server.js   │────▶│  Web Push (FCM)  │────▶│  Service     │
│  occurs    │     │  /api/push   │     │  / web-push      │     │  Worker (SW) │
│            │     │  /send       │     │                  │     │              │
│  • Message │     │              │     │                  │     │  show        │
│  • Leave   │     │              │     │                  │     │  Notific-    │
│  • Alert   │     │              │     │                  │     │  ation()     │
...
- **Push subscription** — auto-registered at app startup (not just on chat page)

The service worker (`sw.ts`) handles both push events and notification clicks, routing to the appropriate page via `data.url`.
